...
\textcolor{red}{BECAREFUL - ERROR!!!} I am here using the whole \(\beta\) pdf \(f_\beta(x)\), while I should use the pdf \(f_{\beta | L}(x | 0)\)!!! Look into this because it is causing a bug
