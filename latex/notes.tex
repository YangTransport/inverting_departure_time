...
\begin{align}
  ...
  \begin{split}
    ...
    & = \int_0^{\beta_\text{max}}\int_{b_i(b)}^{b_e(b)} \mathbb{P}(t^* = t) dt\,\mathbb{P}(\beta = b) db
      \end{split}
\end{align}
...
\begin{equation}
  ...
  \mathbb{P}(L=1, Q=1) = \int_1^{\gamma_\text{max}}\int_{g_i(g)}^{g_e(g)} \mathbb{P}(t^* = t) dt\,\mathbb{P}(\gamma = g) dg
\end{equation}
