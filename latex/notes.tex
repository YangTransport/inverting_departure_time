...
Please note: I'm keeping the notation we used wheen we were speaking,
even if it may be a bit confusing:
\(v(t)\) is indeed not the instantaneous \textit{velocity},
but rather the instantaneous \textit{travel time},
that is directly proportional to the inverse of the velocity.
